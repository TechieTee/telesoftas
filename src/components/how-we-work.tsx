  ...
  return (
        ...
        <div className="lg:px-36 lg:py-16 md:px-24 md:py-16 px-[20px] py-[20px] bg-[#F5F8FF] w-full" id="about">
            ...
            <div className="sm:px-[20px] ">
              <img src={Image.Rectangle12701}  alt="logo" className="lg:w-full lg:h-[400px] md:w-full md:h-[400px] md:object-cover lg:object-cover rounded-[30px]"/> 
            ...
            <div className="flex flex-col items-center justify-center lg:grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 w-full">
              ...
              <div className="sm:px-[20px] ">
              <img src={Image.Rectangle12702}  alt="logo" className="lg:w-full lg:h-[400px] md:w-full md:h-[400px] md:object-cover lg:object-cover rounded-[30px]"/> 
