...
const ViewPort = () => {
  return (
    <div className="lg:px-36 lg:py-16 md:px-24 md:py-16 px-[10px] py-[10px] mt-[100px]  lg:mt-[60px] grid bg-[#FFFFFF] w-full lg:text-left md:text-center text-center" >
        ...
        <div className=" col-span-1 ">
            ...
            <div className="lg:flex lg:justify-start md:justify-center  flex-row gap-2 justify-center w-full">
              ...
              <a href="https://calendly.com/chude-sylvester-telesoftas">
                <button className="text-[16px] py-3 lg:px-6 w-full bg-black text-white border" >
                  Book a Consultation
                </button></a>
              </div>
              <div className="mb-2">
              <a href="www.telesoftas.com">
                <button className="text-[16px] py-3 lg:px-6 w-full border border-black" >
                  Read More
                </button></a>
              </div>
            </div>
